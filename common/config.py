...
argparser.add_argument('--source_path', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/video_imgs', help='Video image directory')
argparser.add_argument('--json_path', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/json_original', help='Face tracklets directory')
argparser.add_argument('--test_path', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/videos_challenge', help='Test set')
argparser.add_argument('--gt_path', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/result_LAM', help='Groundtruth directory')
argparser.add_argument('--train_file', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/split/train.list', help='Train list')
argparser.add_argument('--val_file', type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/split/val.list', help='Validation list')
argparser.add_argument('--prior_path',type=str, default='/data/zhanggl/sda/xj/Ego4d/GazePose-master/json_prior', help='Prior Jsons')
argparser.add_argument('--face_path',type=str, default='/data/zhanggl/sda/xj/Ego4d/Ego4D_LookAtMe/face_imgs', help='Prior Jsons')
...
argparser.add_argument('--pretrained', type=str, default=None, help='ViT checkpoint to load')