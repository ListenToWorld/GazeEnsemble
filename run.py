...
from dataset.data_loader_test import  ImagerLoader, TestImagerLoader
...
from model.model import GazePose,GazeLSTM,GazePoseViT
...
def main(args):
    ...
    if not args.eval and not args.val:
        ...
        for epoch in range(args.epochs):
            postprocess_train = PostProcessor(args, 'train')
